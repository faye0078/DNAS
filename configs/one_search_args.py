...
def obtain_search_args():
    ...
    parser.add_argument('--model_encode_path', type=str, default='/media/dell/DATA/wy/Seg_NAS/model/model_encode/GID-5/one_loop_14layers_mixedcell/first_connect_4.npy')
    parser.add_argument('--model_cell_arch', type=str, default='/media/dell/DATA/wy/Seg_NAS/model/model_encode/GID-5/one_loop_14layers_mixedcell/init_cell_arch.npy', help='the initial cell arch')
