...
def obtain_test_args():
    ...
    # model
    parser.add_argument('--resume', type=str, default='../model/model_encode/14layers_GID5/best_model.pth.tar', help='put the path to resuming file if needed')
    ...
    parser.add_argument('--model_encode_path', type=str, default='../model/model_encode/14layers_GID5/third_connect.npy')
    parser.add_argument('--cell_arch', type=str, default='../model/model_encode/14layers_GID5/cell_operations.npy')
