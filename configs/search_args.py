...
def obtain_search_args():
    ...
    parser.add_argument('--model_encode_path', type=str, default='/media/dell/DATA/wy/Seg_NAS/model/model_encode/uadataset_dfc/12layers/first_connect_4.npy')
    ...
    parser.add_argument('--dataset', type=str, default='uadataset_dfc', choices=['pascal', 'coco', 'cityscapes', 'kd', 'GID', 'hps-GID', 'GID-15', 'uadataset_dfc'], help='dataset name (default: pascal)')
