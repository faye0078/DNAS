# this model is derived from cityscapes(60 epoches) autodeeplab supernet using multi decode
...
class newModel(nn.Module):
    def __init__(self, network_arch, cell_arch, num_classes, num_layers, filter_multiplier=20, lock_multiplier=5, step=5, cell=Cell,
        ...
        self.cell_1_0_1 = cell(self._step, self._block_multiplier, initial_fm / args.block_multiplier,
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[0], 0, self.args)

        self.cell_2_0_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[0], 0, self.args)

        self.cell_3_0_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[0], 0, self.args)

        self.cell_4_0_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[0], 0, self.args)

        self.cell_5_0_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[0], 0, self.args)
        self.cell_5_1_0 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], -1, self.args)

        self.cell_6_0_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[0], 0, self.args)
        self.cell_6_1_0 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], -1, self.args)
        self.cell_6_1_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
        ...
        self.combine_6 = nn.Sequential(
            nn.Conv2d(self._filter_multiplier * filter_param_dict[1] * 5 * 2,
                      self._filter_multiplier * filter_param_dict[1] * 5, 3, stride=1, padding=1),
            BatchNorm(self._filter_multiplier * filter_param_dict[1] * 5))

        self.cell_7_0_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[0], 0, self.args)
        self.cell_7_1_0 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], -1, self.args)
        self.cell_7_1_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[1], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], 0, self.args)
        ...
        self.cell_8_0_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[0], 0, self.args)
        self.cell_8_1_0 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], -1, self.args)
        self.cell_8_1_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[1], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], 0, self.args)
        self.cell_8_2_0 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[1], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[2], -1, self.args)
        self.combine_8 = nn.Sequential(
            nn.Conv2d(self._filter_multiplier * filter_param_dict[1] * 5 * 2,
                      self._filter_multiplier * filter_param_dict[1] * 5, 3, stride=1, padding=1),
            BatchNorm(self._filter_multiplier * filter_param_dict[1] * 5))
        ...
        self.cell_9_1_0 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], -1, self.args)
        self.cell_9_1_1 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[1], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], 0, self.args)
        self.combine_9_1 = nn.Sequential(
            nn.Conv2d(self._filter_multiplier * filter_param_dict[1] * 5 * 2,
                      self._filter_multiplier * filter_param_dict[1] * 5, 3, stride=1, padding=1),
            BatchNorm(self._filter_multiplier * filter_param_dict[1] * 5))
        self.cell_9_2_0 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[1], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[2], -1, self.args)
        ...
        self.combine_9_2 = nn.Sequential(
        ...
        self.cell_10_1_0 = cell(self._step, self._block_multiplier,
                               ...
                               self._filter_multiplier * filter_param_dict[0], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[1], -1, self.args)
        self.cell_10_2_0 = cell(self._step, self._block_multiplier,
                               self._filter_multiplier * filter_param_dict[0],
                               self._filter_multiplier * filter_param_dict[1], self.cell_arch,
                               self._filter_multiplier * filter_param_dict[2], -1, self.args)
        self.cell_10_2_1 = cell(self._step, self._block_multiplier,
                                self._filter_multiplier * filter_param_dict[2],
                                self._filter_multiplier * filter_param_dict[2], self.cell_arch,
                                self._filter_multiplier * filter_param_dict[2], 0, self.args)
        self.combine_10 = nn.Sequential(
            nn.Conv2d(self._filter_multiplier * filter_param_dict[2] * 5 * 2,
                      self._filter_multiplier * filter_param_dict[2] * 5, 3, stride=1, padding=1),
            BatchNorm(self._filter_multiplier * filter_param_dict[2] * 5))
        ...
        self.cell_11_0_2 = cell(self._step, self._block_multiplier,
                                ...
                                self._filter_multiplier * filter_param_dict[1], self.cell_arch,
                                self._filter_multiplier * filter_param_dict[0], 1, self.args)
        self.cell_11_1_2 = cell(self._step, self._block_multiplier,
                                self._filter_multiplier * filter_param_dict[2],
                                self._filter_multiplier * filter_param_dict[2], self.cell_arch,
                                self._filter_multiplier * filter_param_dict[1], 1, self.args)
        self.cell_11_2_0 = cell(self._step, self._block_multiplier,
                                ...
                                self._filter_multiplier * filter_param_dict[1], self.cell_arch,
                                self._filter_multiplier * filter_param_dict[2], -1, self.args)
        self.cell_11_3_0 = cell(self._step, self._block_multiplier,
                                self._filter_multiplier * filter_param_dict[2],
                                self._filter_multiplier * filter_param_dict[2], self.cell_arch,
    ...
    def forward(self, x):
        ...
        x_1_0 = self.cell_1_0_1(stem1, x_0_0)

        x_2_0 = self.cell_2_0_1(x_0_0, x_1_0)

        x_3_0 = self.cell_3_0_1(x_1_0, x_2_0)

        x_4_0 = self.cell_4_0_1(x_2_0, x_3_0)

        x_5_0 = self.cell_5_0_1(x_3_0, x_4_0)
        x_5_1 = self.cell_5_1_0(x_3_0, x_4_0)

        x_6_0 = self.cell_6_0_1(x_4_0, x_5_0)
        x_6_1_0 = self.cell_6_1_0(x_4_0, x_5_0)
        x_6_1_1 = self.cell_6_1_1(x_4_0, x_5_1)
        x_6_1 = torch.cat([x_6_1_0, x_6_1_1], dim=1)
        x_6_1 = self.combine_6(x_6_1)

        x_7_0 = self.cell_7_0_1(x_5_0, x_6_0)
        x_7_1_0 = self.cell_7_1_0(x_5_0, x_6_0)
        x_7_1_1 = self.cell_7_1_1(x_5_0, x_6_1)
        x_7_1 = torch.cat([x_7_1_0, x_7_1_1], dim=1)
        x_7_1 = self.combine_7(x_7_1)

        x_8_0 = self.cell_8_0_1(x_6_0, x_7_0)
        x_8_1_0 = self.cell_8_1_0(x_6_0, x_7_0)
        x_8_1_1 = self.cell_8_1_1(x_6_0, x_7_1)
        x_8_1 = torch.cat([x_8_1_0, x_8_1_1], dim=1)
        x_8_1 = self.combine_8(x_8_1)
        x_8_2 = self.cell_8_2_0(x_6_0, x_7_1)

        x_9_0 = self.cell_9_0_2(x_7_0, x_8_1)
        x_9_1_0 = self.cell_9_1_0(x_7_0, x_8_0)
        x_9_1_1 = self.cell_9_1_1(x_7_0, x_8_1)
        x_9_1 = torch.cat([x_9_1_0, x_9_1_1], dim=1)
        x_9_1 = self.combine_9_1(x_9_1)
        x_9_2_0 = self.cell_9_2_0(x_7_0, x_8_1)
        x_9_2_1 = self.cell_9_2_1(x_7_1, x_8_2)
        x_9_2 = torch.cat([x_9_2_0, x_9_2_1], dim=1)
        x_9_2 = self.combine_9_2(x_9_2)

        x_10_1 = self.cell_10_1_0(x_8_1, x_9_0)
        x_10_2_0 = self.cell_10_2_0(x_8_0, x_9_1)
        x_10_2_1 = self.cell_10_2_1(x_8_2, x_9_2)
        x_10_2 = torch.cat([x_10_2_0, x_10_2_1], dim=1)
        x_10_2 = self.combine_10(x_10_2)

        x_11_0 = self.cell_11_0_2(x_9_0, x_10_1)
        x_11_1 = self.cell_11_1_2(x_9_2, x_10_2)
        x_11_2 = self.cell_11_2_0(x_9_0, x_10_1)
        x_11_3 = self.cell_11_3_0(x_9_2, x_10_2)
