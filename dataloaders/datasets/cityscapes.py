...
def sp(args, split='train'):
    ...
    return CityscapesSegmentation(args, split='train', part=ls[split:]), CityscapesSegmentation(args, split='train',
                                                                                                part=ls[:split])
...
class CityscapesSegmentation(data.Dataset):
    ...
    def __init__(self, args, root=get_data_path('cityscapes'), split="train", part=None):
        self.NUM_CLASSES = 19
        self.root = root
        self.split = split
        self.args = args
